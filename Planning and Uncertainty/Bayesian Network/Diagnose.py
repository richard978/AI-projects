...
marginals = model.predict_proba({'PatientAge':'31-65','CTScanResult':'Ischemic Stroke'})
print marginals[5].parameters[0]['True']
marginals = model.predict_proba({'PatientAge':'65+','MRIScanResult':'Hemmorraghic Stroke'})
print marginals[6].parameters[0]['Moderate']
marginals = model.predict_proba({'PatientAge':'65+','CTScanResult':'Hemmorraghic Stroke','MRIScanResult':'Ischemic Stroke'})
print marginals[4].parameters[0]['Stroke Mimic']
marginals = model.predict_proba({'PatientAge':'0-30'})
print marginals[3].parameters[0]['Not used']
